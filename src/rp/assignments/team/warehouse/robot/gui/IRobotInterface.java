...
public interface IRobotInterface {
    ...
    /**
     * Asks the user to press the ENTER button to confirm picking up the items. Waits till the user has picked up all
    ...
    /**
     * Asks the user to press the ENTER button to confirm dropping off the items. Waits till the user has dropped off
     * all the items before returning
     *
